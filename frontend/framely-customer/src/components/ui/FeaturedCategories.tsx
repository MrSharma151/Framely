          ...
          >
            ...
            <div className="relative w-full h-52 sm:h-56 lg:h-60 overflow-hidden">
              ...
              <div className="absolute inset-0 bg-gradient-to-t 
                ...
                group-hover:to-black/20"></div>

              {/* ✅ Smooth Fade-in Text */}
              <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-3">
                <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-white drop-shadow-xl tracking-wide 
                  transition-transform duration-700 ease-[cubic-bezier(0.4,0,0.2,1)] group-hover:translate-y-[-4px]">
                  {cat.name}
                </h3>
                <span className="mt-2 text-xs sm:text-sm text-[var(--foreground-muted)] 
