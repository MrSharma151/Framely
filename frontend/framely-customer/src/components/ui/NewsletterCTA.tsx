...
import Button from "./Button"; // ✅ Premium Button Component
...
export default function NewsletterCTA() {
  return (
    <section className="relative py-24 overflow-hidden">
      ...
      {/* ✅ Slight gradient strip for luxury feel */}
      ...
      <div className="relative z-10 container mx-auto text-center px-4 max-w-3xl">
        ...
        <div
          className="mt-10 flex flex-col sm:flex-row items-stretch sm:items-center 
          gap-3 sm:gap-0 glass rounded-full p-2 shadow-lg hover:shadow-[0_0_30px_rgba(0,140,255,0.2)] transition-all duration-500"
        >
          {/* ✅ Mail Icon + Input */}
          <div className="flex items-center gap-3 flex-1 px-4">
            ...
            <input
              ...
              className="flex-1 bg-transparent py-3 text-white placeholder-[var(--foreground-muted)] focus:outline-none text-sm sm:text-base"
            />
          </div>
