    ...
    <section className="relative py-24">
      ...
      <div className="relative z-10 container mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 px-6">
        {reviews.map((r, i) => (
          <div
            key={i}
            className="group glass p-8 rounded-2xl text-center shadow-lg 
          ...
          >
            ...
            <div className="absolute -top-6 left-1/2 -translate-x-1/2 w-12 h-12 flex items-center justify-center rounded-full bg-[var(--background-alt)] shadow-inner shadow-black/40 group-hover:scale-110 transition duration-500">
            ...
            {/* ✅ Divider accent */}
            <span className="mx-auto mt-6 mb-4 block w-12 h-0.5 bg-[var(--accent)] opacity-50 group-hover:opacity-100 transition duration-500"></span>
