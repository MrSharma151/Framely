...
// ✅ Correct UTC → IST conversion
function formatISTDate(utcDate: string) {
  const utc = new Date(utcDate); // pure UTC date

  // ✅ Add IST offset (5 hours 30 min = 19800 seconds)
  const istMillis = utc.getTime() + (5.5 * 60 * 60 * 1000);
            ...
            return (
              ...
              >
                ...
                <div className="flex flex-col md:flex-row justify-between gap-3 items-start md:items-center">
                  ...
                  <div>
                    <h2
                      className="flex items-center gap-2 text-lg sm:text-xl font-bold text-pink-400"
                    >
                  ...
                  <div className="flex flex-wrap gap-3 items-center">
                    <span
                      className={`px-4 py-1 rounded-full text-xs font-semibold shadow-md ${styles.badge}`}
                    >
                      {order.status}
                    </span>
                ...
                <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-3 text-sm text-gray-300">
                  ...
                  <p>
                    📞 <span className="font-semibold">Mobile:</span> {order.mobileNumber}
                  </p>
                ...
                {/* ✅ Extra info + Cancel button */}
                {order.status === "Pending" && (
                  <>
                    <div className="mt-4 text-xs text-gray-400">
                      ℹ️ Our team may contact you if any prescription or lens
                      details are required before processing.
                    </div>
